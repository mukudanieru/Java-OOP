package projectcoding.expression;
...
import projectcoding.expression.classes.binaryoperation.addition.Addition;
import projectcoding.expression.classes.binaryoperation.multiplication.Multiplication;
import projectcoding.expression.classes.constant.Constant;
import projectcoding.expression.classes.unaryoperation.negation.Negation;
import projectcoding.expression.classes.variable.Variable;
...
public class ExpressionTester {
    ...
    public static void main(String[] args) {
        ...
        Variable v3 = new Variable("x1");
        Variable v4 = new Variable("x2", 4);
        v3.setValue(10);
